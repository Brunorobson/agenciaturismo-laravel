...
<section class="menu">
	...
	<div class="logo">
		<img src="{{url('assets/panel/imgs/logo.png')}}" alt="EspecializaTi" class="logo-painel">
	</div>
	...
	<div class="top-dashboard">
		...
		<div class="dropdown user-dash">
		  <div class="dropdown-toggle" id="dropDownCuston" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
		    <img src="{{url('assets/panel/imgs/user.png')}}" alt="Carlos Ferreira" class="user-dashboard img-circle">
